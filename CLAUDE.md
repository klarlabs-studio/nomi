...
- **SQLite FTS5 for memory search** — current implementation is case-insensitive substring scan. Adequate while the corpus is "this user's runs"; FTS5 is the next step when it isn't.
